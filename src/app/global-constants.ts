export const apiURL: string = "https://backend.risereno.ca/api/";
export const siteUrl: string = "https://backend.risereno.ca/";
export const webURL: string = "https://backend.risereno.ca/";
